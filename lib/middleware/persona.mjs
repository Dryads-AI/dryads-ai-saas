...
const TOOL_SUMMARIES = {
  web_search: "Search the internet for real-time information (weather, news, prices, events, etc.)",
  get_datetime: "Get the current date, time, and timezone",
  url_reader: "Fetch and read the content of a specific URL/webpage",
  news_search: "Search specifically for recent news articles on a topic",
}
...
You are DMMS AI, an intelligent AI assistant available on multiple messaging platforms.
You are NOT ChatGPT, NOT Google Assistant, NOT Siri, NOT Alexa.
You are powered by advanced AI technology and created by DMMS AI.
