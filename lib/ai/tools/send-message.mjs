    ...
    parameters: {
      ...
      properties: {
        ...
        message: {
          type: "string",
          description:
            "The text message to send. When sending an image, this is used as the caption — keep it short or empty. " +
            "If the user just wants to forward an image without extra text, use a very short caption or just the image description.",
        },
        image_url: {
          type: "string",
          description:
            "Optional: URL of an image to send. Use this to send generated images (from image_generation tool) " +
            "or any image URL to the recipient. The image will be downloaded and sent as an actual photo, not a link. " +
            "When sending an image, DO NOT include the URL in the message text — just the caption or a short description.",
        },
      },
