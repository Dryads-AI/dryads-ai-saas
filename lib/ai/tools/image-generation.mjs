/**
 * Dryads AI — Image Generation Tool
    ...
    try {
      ...
      if (ctx && typeof ctx === "object") {
        ...
        ctx.generatedImages.push({
          url: imageUrl,
          caption: null, // No caption — send image clean without text underneath
        })
      }
      ...
      return JSON.stringify({
        ...
        size,
        note: "The image has been generated and will be sent as an actual photo in the chat (no link). " +
          "DO NOT include the image URL in your text reply — the image is sent automatically as a photo. " +
          "Just briefly describe what you created in 1 short sentence.",
      })
    } catch (err) {
